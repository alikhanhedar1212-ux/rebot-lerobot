...
impl DmDeviceBus {
    pub fn open(device_type: DmDeviceType, dm_channel: &str) -> Result<Self> {
        Self::open_indexed(device_type, dm_channel, 0)
    }
    ...
    pub fn open_indexed(
        ...
        Self::open_with_config_indexed(device_type, dm_channel, device_index, 1_000_000, 5_000_000)
    }
    ...
    pub fn open_with_config(
        ...
        Self::open_with_config_indexed(device_type, dm_channel, 0, can_baudrate, canfd_baudrate)
    }

    pub fn open_with_config_indexed(
        device_type: DmDeviceType,
        dm_channel: &str,
        device_index: u32,
        can_baudrate: u32,

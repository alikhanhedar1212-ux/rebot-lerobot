...
class OpenCVCameraConfig(CameraConfig):
    ...
    # Optional reference to an earlier OpenCV camera whose frames should be
    # reused.  False means this configuration owns and opens its own device.
    # camera/utils.py already supports this field; keep it here so configs made
    # through draccus have the attribute as well.
